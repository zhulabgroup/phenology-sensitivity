...
red_maple <- temperature_data %>% filter(dataset == "herb",species == "Quercus parvula")
...
normality_plot <- red_maple %>% 
  ...
  geom_smooth(aes(group = dataset), method = "lm", se = TRUE, size = 2, color = "red") +
  labs(
    title = " ",
...
spa_sen <- ggplot(data = purple) +
  ...
  geom_line(mapping = aes(x = x, y = y), color = "red", size = 2) +
  theme(
...
tem_sen <- ggplot(data = purple) +
  # geom_point(aes(x = x, y = y)) +
  geom_line(mapping = aes(x = x, y = y), color = "purple") +
  theme(
    axis.text.x = element_blank(),
    axis.text.y = element_blank(),
    axis.ticks = element_blank(),
...
co_gradient <- ggplot(mapping = aes(x = x, y = y)) +
      geom_line(data = red, color = "red", size = 3) +
geom_line(data = purple_co, color = "purple") +
...
no_adaptation <- ggplot() +
  geom_line(data = purple, aes(x = x, y = y), color = "purple") +
    geom_line(data = purple, aes(x = x, y = y+0.04), color = "red", size = 3) +
  # geom_hline(yintercept = 0.4, linetype = "dashed") +
  # geom_vline(xintercept = 0.6, linetype = "dashed") +
  labs(
    # x = expression(t[observe]),
...
counter_gradient <- ggplot(mapping = aes(x = x, y = y)) +
  geom_line(data = red, color = "red", size = 3) +
  geom_line(data = purple_counter, color = "purple") +
  labs(
    x = "Temperature observed",
    y = "Flowering day observed",
