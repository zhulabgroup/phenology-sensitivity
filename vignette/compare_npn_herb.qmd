...
ggplot(joint_data, aes(x = norm_estimate, y = species, color = taxa, alpha = -residual, shape = dataset)) +
  geom_point(size = 3) +
...
```
```{r}
ggplot(joint_data, aes(x = anom_estimate, y = species, color = taxa, alpha = -residual, shape = dataset)) +
  geom_point(size = 3) +
